...
export const BadgeStyles = ui.variants({
  base: [
...
export type BadgeProps = UIComponentVariantProps<typeof BadgeStyles> & React.ComponentPropsWithoutRef<'span'>;

export const Badge = ui.span(BadgeStyles);

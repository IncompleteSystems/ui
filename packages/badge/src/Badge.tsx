...
import Link from '@incomplete/ux.touchtarget';

const BadgeStyles = ui.variants({
  base: 'inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline',
  variants: {
    color: {
...
export function Badge({ color = 'zinc', className, ...props }: BadgeProps & React.ComponentPropsWithoutRef<'span'>) {
  const Badge = ui.span(BadgeStyles);

...
export const CheckboxStyles = ui.variants({
  base: [
    // Basic layout
...
export type CheckboxProps = UIComponentVariantProps<typeof CheckboxStyles> 
...
export function Checkbox({
  ...
  const CheckboxBase = ui.span(CheckboxStyles);
